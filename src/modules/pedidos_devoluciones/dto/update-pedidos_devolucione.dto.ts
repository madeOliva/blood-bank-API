...
import { CreatePedidosDevolucionesDto } from './create-pedidos_devolucione.dto';

export class UpdatePedidosDevolucionesDto extends PartialType (CreatePedidosDevolucionesDto) {
    @IsNumber()
    @IsOptional()
